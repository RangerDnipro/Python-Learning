...
class SingletonMeta(type):
    """
    Метаклас SingletonMeta забезпечує, що кожен клас, створений з його використанням,
    матиме лише один екземпляр.

    Атрибути:
    -----------
    _instances : dict
        Словник, що зберігає екземпляри класів, для яких метаклас гарантує унікальність.
    """
    ...
    def __call__(cls, *args, **kwargs):
        ...
        ----------
        cls : type
            Клас, для якого створюється або повертається екземпляр.
        *args : tuple
            Позиційні аргументи для конструктора класу.
        **kwargs : dict
            Іменовані аргументи для конструктора класу.

        Повертає:
        ---------
        instance : object
            Екземпляр класу, створений або вже існуючий.
        """
...
class Singleton(metaclass=SingletonMeta):
    """
    Клас Singleton використовує метаклас SingletonMeta для гарантії,
    що він матиме лише один екземпляр.

    Методи:
    -------
    __init__():
        Конструктор класу, який викликається лише при першому створенні екземпляра.
        Виводить повідомлення про створення екземпляра.
    """
