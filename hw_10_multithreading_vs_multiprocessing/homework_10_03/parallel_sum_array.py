"""
Програма використовує модуль multiprocessing для паралельного обчислення суми великого 
масиву чисел, розділяючи його на частини та обробляючи кожну частину у окремому процесі
"""
